...
public interface OrderedStructure {
    ...
    /**
     * Adds an element in increasing order according to the class' natural
     * comparison method (i.e. uses the method compareTo).
     *
     * @param element the element to be added to the ordered structure
     * @return true if the element can be successfully added to and false otherwise.
    ...
    /**
     * Returns the element at the specified position; the first element has the
     * index 0.
     *
    ...
    /**
     * Removes the element at the specified position; the first element has the
     * index 0.
     *
